 ...
 * Checks BOTH Title Keywords and Genre Tags.
 */
object SmartCuratedLists {
    ...
    val categories: Map<String, List<String>> = mapOf(
        ...
        "🦁 The Lion King & Safari" to listOf("lion king", "simba", "mufasa", "scar", "nala", "safari", "savanna"),
        "🤡 Clown & Circus" to listOf("clown", "circus", "joker", "pennywise", "it chapter"),

        // --- Horror & Thriller (Uses Genre Tags) ---
        "👻 Best Horror" to listOf("horror", "scary", "terrifying", "slasher"),
        ...
        "⚔️ Best Action" to listOf("action", "adventure", "fight", "war", "battle"),
        ...
        "💖 Romantic Dramas" to listOf("romance", "romantic", "love story", "dating"),
        "😂 Best Comedies" to listOf("comedy", "funny", "hilarious", "humor"),
        ...
        "🤖 Mecha & Sci-Fi Anime" to listOf("gundam", "evangelion", "code geass", "ghost in the shell", "akira", "steins;gate", "cowboy bebop"),
        "🌸 Best Anime" to listOf("anime", "animation", "japanese", "manga")
    )
}

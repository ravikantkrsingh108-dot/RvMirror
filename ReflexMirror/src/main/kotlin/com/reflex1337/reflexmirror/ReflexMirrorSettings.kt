...
// Studio toggle entry for reflexmirror
data class StudioOption(val key: String, val label: String, val cookieValue: String)

class reflexmirrorSettings(
    private val plugin: reflexmirrorPlugin,
    ...
    private fun getStudioRow(option: StudioOption): RelativeLayout {
        val relativeLayout = RelativeLayout(this@reflexmirrorSettings.requireContext()).apply {
        ...
        val checkBox = CheckBox(this@reflexmirrorSettings.requireContext()).apply {
        ...
        val textView = TextView(this@reflexmirrorSettings.requireContext()).apply {
            id = View.generateViewId()
            text = option.label
            textSize = 16f
            layoutParams = RelativeLayout.LayoutParams(
